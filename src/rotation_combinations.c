...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   rotation_combinations.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ashalagi <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/15 15:49:27 by ashalagi          #+#    #+#             */
/*   Updated: 2023/07/15 16:52:43 by ashalagi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
This function calculate and decides which rotation combination
is best to use to sort the stack. Of course, after rotation
there is always one push operation is left to do which i embeded
to code. Function is used during push from B to A.
*/
...
is best to use to sort the stack. Of course, after rotation
there is always one push operation is left to do which i embeded
to code. Function is used during push from A to B.
*/
